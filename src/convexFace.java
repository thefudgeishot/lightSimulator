...
public class convexFace extends face{
    ...
    // https://www.desmos.com/calculator/o02rdhiypa
    public convexFace(PApplet applet, float scale, float height, float[] origin) {
